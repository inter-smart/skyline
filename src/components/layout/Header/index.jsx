...
export default function Header() {
  ...
  const menuLinks = "text-[11px] xl:text-[13px] 2xl:text-[14px] 3xl:text-[18px] text-[#010101] font-normal flex items-center justiy-center transition-all duration-100 hover:text-base1 relative p-[20px_0]"
  ...
  return (
    <header>
      ...
      <div className="container min-lg:hidden relative pr-[40px]">
        <Sheet >
          <SheetTrigger className="w-[25px] xl:w-[32px] 2xl:w-[40px] 3xl:w-[50px] h-[25px] xl:h-[32px] 2xl:h-[40px] 3xl:h-[50px] absolute top-0 bottom-0 right-0 m-auto
          ...
          <SheetContent side="right" className="bg-base2 p-[40px_25px] md:p-[45px_35px] 2xl:p-[50px_40px] 3xl:p-[80px_50px_70px] h-screen overflow-auto border-none sidemenu
                      !max-w-[300px] xl:!max-w-[400px] 3xl:!max-w-[500px]">
            <SheetDescription >
              <div className="text-[20px] xl:text-[25px] 2xl:text-[28px] 3xl:text-[36px] font-normal text-white font-unna mb-[20px]">Contact Information</div>
              <ul className="mb-[30px] 3xl:mb-[35px]">
