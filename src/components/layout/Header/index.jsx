                          ...
                          <ul className="mb-[30px] 3xl:mb-[35px]">
                            ...
                            <li className="mb-[20px] 2xl:mb-[25px] 3xl:mb-[30px] last-of-type:mb-0">
                              ...
                              <div className={`${cmnMenuClass} font-normal mb-[12px] flex items-center`} aria-label="email_link">
                                Main:{" "}
                                <a href="tel:024 7XXX XXXX" className="flex items-center pl-1">
                                  {" "}
                                  024 7XXX XXXX
                                </a>
                              </div>
                                      ...
                                      <g id="Group_175" data-name="Group 175" transform="translate(0)">
                                        <g id="Group_174" data-name="Group 174" clip-path="url(#clip-path)">
                                          <path
                                            id="Path_139"
                                            data-name="Path 139"
                                            d="M2.425,0a2.234,2.234,0,1,0-.056,4.456H2.4A2.235,2.235,0,1,0,2.425,0"
                                          ></path>
                                          <rect
                                            id="Rectangle_90"
          ...
          >
            <SheetDescription>
              ...
              <ul className="mb-[30px] 3xl:mb-[35px]">
                <li className="mb-[20px] 2xl:mb-[25px] 3xl:mb-[30px] last-of-type:mb-0">
                  <div className={`${cmnMenuClass}`}>Location</div>
                  <div className={`${cmnMenuClass} font-normal`}>Skyline Hospitals Coventry, 123 Medical Way Coventry, CV1 2AB, United Kingdom</div>
                </li>
                <li className="mb-[20px] 2xl:mb-[25px] 3xl:mb-[30px] last-of-type:mb-0">
                  <div className={`${cmnMenuClass}`}>Email</div>
                  <a
