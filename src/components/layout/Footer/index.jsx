        ...
        <footer className='w-full bg-base2 pt-[80px]'>
            <div className="container mb-[50px]">
                <div className='bg-[#FDFDFD] p-[15px] sm:p-[20px] lg:p-[10px_20px] xl:p-[10px_35px] 2xl:p-[12px_45px] 3xl:p-[17px_55px]
                   rounded-[6px] overflow-hidden mb-[40px]'>
                    <div className='flex flex-wrap items-center '>
                        <div className='w-[190px] xl:w-[240px] 2xl:w-[290px] 3xl:w-[360px]'>
                            <div className='xl:max-w-[240px] 2xl:max-w-[285px] 3xl:max-w-[350px]'>
                                <Image src="/images/logo.svg" width="360" height="165" alt="logo" />
                            </div>
                        </div>
                        <div className='w-full lg:w-[calc(100%-190px)] xl:w-[calc(100%-240px)] 2xl:w-[calc(100%-290px)] 3xl:w-[calc(100%-360px)] lg:pl-[30px] 2xl:pl-[50px] 3xl:pl-[60px] flex flex-wrap items-center justify-between'>
                            <div className='text-[24px] md:text-[28px] lg:text-[32px] xl:text-[40px] 2xl:text-[47px] 3xl:text-[60px] text-base1 font-normal font-unna'>Excellence in Healthcare</div>

                            {/* social Links */}
                            <div className="lg:max-w-[250px] 3xl:max-w-[300px]">
                ...
                <div className="flex flex-wrap ">
                    <div className="w-full sm:w-4/12 lg:w-2/12 p-[10px]">
                        <Accordion type="single" collapsible defaultValue="item-1">
                            <AccordionItem value="item-1">
                                <AccordionTrigger className="!gap-0 !p-0 m-0 [&>svg]:hidden pointer-events-none">
                    ...
                    <div className="w-full sm:w-6/12 md:w-4/12  lg:w-3/12 p-[10px] 2xl:pl-[60px] 3xl:pl-[90px]  max-lg:order-6">
                        <Accordion type="single" collapsible defaultValue="item-1">
                            <AccordionItem value="item-1">
                                <AccordionTrigger className="!gap-0 !p-0 m-0 [&>svg]:hidden pointer-events-none">
                                    <div className="text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[20px] text-white font-medium  mb-[20px] 3xl:mb-[30px]">
                    ...
                    <div className="w-full sm:w-6/12 md:w-4/12 lg:w-3/12 p-[10px] 2xl:pl-[60px] 3xl:pl-[90px] max-lg:order-5">
                        <Accordion type="single" collapsible defaultValue="item-1">
                            <AccordionItem value="item-1">
                                <AccordionTrigger className="!gap-0 !p-0 m-0 [&>svg]:hidden pointer-events-none lg:hidden">
                                    <div className="text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[20px] text-white font-medium  mb-[20px] 3xl:mb-[30px]">
                                        Opening Hours
                                    </div>
                                </AccordionTrigger>
                                <AccordionContent className="p-0">
                                    ...
                                    <div className="2xl:text-[15px] 3xl:text-[20px] text-white font-medium  mb-[8px] 3xl:mb-[10px]">
                                        Opening Hours
                                    </div>
