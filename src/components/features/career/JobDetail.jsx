    ...
    return (
        <AlertDialog>
            ...
            h-[25px] xl:!min-h-[32px] 2xl:!min-h-[35px] 3xl:!min-h-[50px] 3xl:leading-[32px;]
             ...
             bg-transparent border border-[#671448] hover hover:text-[#ffffff] leading-0 tracking-[0.9px]">VIEW DETAILS
            </AlertDialogTrigger>

            <AlertDialogContent className="max-w-[95%] sm:!max-w-[630px] 2xl:!max-w-[750px] 3xl:!max-w-[950px] bg-white p-[40px_20px] lg:p-[35px_25px] 
                ...
                <AlertDialogHeader>
                    <div className="w-full relative mb-[5px] 2xl:mb-[10px] 3xl:mb-[20px]">
                        ...
                        <div className="text-[25px] xl:text-[33px] 2xl:text-[40px] 3xl:text-[50px] text-[#212121] text-left mb-[15px] leading-none">ICU Nurse</div>
                        <ul className="flex items-center gap-3">

                            <li className="relative text-[11px] 2xl:text-[13px] 3xl:text-[16px] text-[#212121] font-normal pl-[20px] 3xl:pl-[25px]
                            ...
                            <li className="relative text-[11px] 2xl:text-[13px] 3xl:text-[16px] text-[#212121] font-normal pl-[25px]
                ...
                <AlertDialogDescription className="mb-0">
                    <div className="w-full">
                        <div className="text-[11px] xl:text-[13px] 2xl:text-[16.761px] 3xl:text-[20px] text-[#00335B] font-normal 
                        leading-normal mb-[10px] 3xl:mb-[15px]">Key Requirements:</div>
                    ...
                    <div className="w-full">
                        <div className="text-[11px] xl:text-[13px] 2xl:text-[16.761px] 3xl:text-[20px] text-[#00335B] 
                            font-normal leading-normal mb-[15px] 3xl:mb-[20px]">Job Description:</div>
                        <div className="w-full">
                            <p className="2xl:text-[12px] 3xl:text-[16px] text-[#1E1E1E] w-max-full mb-0 ">
                                ...
                                the prevention, diagnosis, and treatment of musculeletal conditions, including bones, joints, ligaments, tendons, and muscles. This role involves
                                performing surgical and non-surgical
                                interventions, providing patient-centered care, and collaborating with a multidisciplinary team to achieve the best outcomes.
                            </p>
                        </div>
                    </div>
