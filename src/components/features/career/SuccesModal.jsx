          ...
          <div className="max-w-[250px] 2xl:max-w-[400px] m-auto">
            ...
            >
              <svg width="121" height="121" viewBox="0 0 121 121" fill="none">
                ...
                />
                <path
                  d="M44.7441 87.2114L75.6473 118.115C101.242 111.289 120.201 87.9697 120.201 60.1C120.201 59.5312 120.201 58.9625 120.201 58.3937L95.9334 36.0221L44.7441 87.2114Z"
                  fill="#A6CBFF"
                />
                <path
                  d="M61.6188 73.561C64.273 76.2153 64.273 80.7654 61.6188 83.4197L56.1207 88.9178C53.4664 91.572 48.9162 91.572 46.262 88.9178L22.1841 64.6503C19.5298 61.996 19.5298 57.4459 22.1841 54.7916L27.6822 49.2935C30.3364 46.6392 34.8866 46.6392 37.5408 49.2935L61.6188 73.561Z"
                  fill="white"
                />
                <path
                  d="M82.6634 31.6615C85.3176 29.0073 89.8678 29.0073 92.522 31.6615L98.0201 37.1596C100.674 39.8139 100.674 44.3641 98.0201 47.0183L56.3104 88.5385C53.6561 91.1928 49.106 91.1928 46.4517 88.5385L40.9536 83.0404C38.2993 80.3861 38.2993 75.836 40.9536 73.1817L82.6634 31.6615Z"
                  fill="white"
                />
              </svg>
            </div>
            ...
            <AlertDialogCancel
              className="text-[10px] 2xl:text-[11px] 3xl:text-[15px] font-medium uppercase border border-[#00335B] text-[#00335B]
