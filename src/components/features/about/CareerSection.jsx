...
export default function CareerSection({about_cms}) {
    ...
    return (
        <section class="relative w-full h-full py-[60px] lg:py-[90px] xl:py-[110px] 2xl:py-[130px] 3xl:py-[170px]  min-h-[300px] lg:min-h-[420px] xl:min-h-[500px] 2xl:min-h-[670px] 3xl:min-h-[690px] 
            ...
            <div className="container w-full h-full flex items-center lg:w-4/5 md:ml-auto relative z-1">
                ...
                >
                    ...
                    <p>{parseHtmlWithoutClasses(about_cms?.section8_description)}</p>
