...
export default function CareerSection({ about_cms }) {
  ...
  return (
    <section
      className="relative w-full h-full py-[60px] lg:py-[90px] xl:py-[110px] 2xl:py-[130px] 3xl:py-[170px]  min-h-[250px] lg:min-h-[320px] xl:min-h-[450px] 2xl:min-h-[540px] 3xl:min-h-[690px] 
    ...
    >
      ...
      <div className="container w-full h-full flex items-center lg:w-4/5 md:ml-auto relative z-1">
        ...
        >
          ...
          <div className="bg-[#671448] btn-base1 hover min-w-[110px] 2xl:min-w-[130px] 3xl:min-[165px]" aria-label="apply_btn">
            APPLY NOW
          </div>
        </motion.div>
      </div>
