...
export default function OurvalueSection({ about_cms, values }) {
  return (
        ...
        <div className="flex flex-wrap -m-[8px]">
          ...
          <div className="w-full md:w-1/2 p-[8px]">
            <div className="w-full">
              <SubTitle size="SubTitle" as="div" className="!mb-[5px] 2xl:!mb-[15px]">
          ...
          <div className="w-full md:w-1/2 p-[8px]">
            <Accordion type="single" collapsible defaultValue="item-1" className="rounded-[4px] overflow-hidden bg-[rgba(197,221,255,0.35)]">
              {values.map((item, index) => (
                ...
                >
                  <AccordionTrigger className="text-[12px] xl:text-[16px] 2xl:text-[19px] 3xl:text-[24px] text-[#00335B] font-normal uppercase p-0 [&>svg]:hidden tracking-wider !no-underline flex items-center justify-start">
                    ...
                    <div className="w-[calc(100%-28px)] xl:w-[calc(100%-33px)] 2xl:w-[calc(100%-40px)] 3xl:w-[calc(100%-50px)]">{item.title}</div>
                  </AccordionTrigger>
