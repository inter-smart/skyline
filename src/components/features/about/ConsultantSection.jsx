...
const consultants = [
  {
    ...
    image_alt_text_value: "Dr. John Smith",
  },
  {
    name: "Dr. Jane Doe",
    designation: "Chief Medical Officer",
    image_value: "/images/team2.png",
    bgLogo: "/images/bgLogo1.png",
    image_alt_text_value: "Dr. John Smith",
  },
  {
...
export default function ConsultantSection({ team_members, title, preTitle, image }) {
  ...
  return (
    <section className="py-[45px_25px] xl:py-[40px_20px] 2xl:py-[50px] 3xl:py-[70px_90px] relative after:absolute after:top-0 after:left-0 after:w-full after:h-full after:content-[''] after:bg-[rgba(0,51,91,0.92)]">
      <Image
        src={image || "/images/consutlantBg.jpg"}
      ...
      <div className="container">
        ...
        <div className="w-full relative">
          ...
          >
            {team_members.map((consultant, index) => (
