...
export default function YouTubeGallerySection() {
    ...
    useEffect(() => {
        const isoInit = () => {
            isotope.current = new Isotope(".youtube-grid", {
            ...
            imagesLoaded(".youtube-grid", () => isotope.current.layout());
        };

        const timer = setTimeout(() => isoInit(), 100);
            ...
            <div className="container">
                ...
                <div className="flex flex-wrap items-end justify-between -m-[5px] mb-[25px]">
                    <div className="w-full md:w-auto p-[5px]">
                        ...
                        >
                            <SubTitle size="SubTitle" as="div" className="!mb-[10px] leading-none">YouTube Videos</SubTitle>
                            <Heading size="heading1" as="div" className="leading-none !mb-0">
                                Health News<br className="max-md:hidden" /> & Hospital Updates
                            </Heading>
                        </motion.div>
                    </div>
