  ...
  return (
    <section className="bg-[#F6F6F6] py-[40px] 2xl:py-[60px] 3xl:py-[90px]">
      <div className="container">
        ...
        {/* Slider Section */}
        <div
          className="relative lg:mt-[30px] 2xl:mt-[50px] lg:max-w-[640px] xl:max-w-[800px] 2xl:max-w-[960px] 3xl:max-w-[1340px] 
        ...
        >
          ...
          <div className="absolute top-1/2 left-0 right-0 flex justify-between items-center  -translate-y-1/2 z-10">
            {/* Prev Button */}
            <button
              className="navbts-prev bg-base2 w-[22px] md:w-[35px] 2xl:w-[40px] h-[22px] md:h-[35px] 2xl:h-[40px] 
            ...
            {/* Next Button */}
            <button
              className="navbts-next bg-base2 w-[22px] md:w-[35px] 2xl:w-[40px] h-[22px] md:h-[35px] 2xl:h-[40px] rounded-full p-[7px] md:p-[12px] flex items-center justify-center cursor-pointer 
