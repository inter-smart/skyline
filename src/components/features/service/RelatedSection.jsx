...
export default function RelatedSection({ sub_title, title, description, services }) {
      ...
      <div className="container">
        <div className="flex flex-wrap items-end justify-between w-full relative z-10 mb-[25px] 2xl:mb-[40px] 3xl:mb-[50px]">
          <div className="md:w-1/2">
            ...
            <div className="mb-0">{renderHtml(description)} </div>
          </div>
        ...
        <div className="w-full relative">
          <Swiper
            ...
            className="relative w-full h-[265px] lg:h-[280px] xl:h-[320px] 2xl:h-[385px] 3xl:h-[480px]"
            breakpoints={{
