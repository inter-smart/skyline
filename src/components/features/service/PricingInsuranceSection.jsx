...
const plan_benefit_list = [
    {
        ...
        plan_list: ["Blue Cross Blue Shield",
            "Aetna",
            "Cigna",
            "United Healthcare",
            "Humana",
    ...
    },
    {
        ...
        plan_list: ["Preventive care at no cost",
                        ...
                        <div className="flex flex-wrap md:max-w-[800px] xl:max-w-[500px] 2xl:max-w-[600px] 3xl:max-w-[700px]">
                            {plan_benefit_list.map((item, parentIndex) => (
                                <div
                                    ...
                                    className={`w-full md:w-1/2   ${parentIndex % 2 === 0 ? "border-l-none  " : "md:border-l md:border-dashed border-[rgba(75,75,75,0.15)]  md:pl-[25px] xl:pl-[40px] 3xl:pl-[60px]"}`}
                                >
                                    <Heading as="h6" size="heading6" className="leading-[1] font-medium text-start text-base1 mb-[10px] lg:mb-[18px]">
                                        {item.plan_title}
                                    </Heading>
                                    <ul>
                                        {item.plan_list.map((planItem, index) => (
                                            <li
                                                ...
                                                className="text-[11px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[16px] pl-[20px] 2xl:pl-[25px] relative before:absolute before:top-[5px] before:left-0 before:w-[10px] 2xl:before:w-[12px] before:h-[10px] 2xl:before:h-[12px] before:bg-[url('/images/tick.svg')] before:bg-no-repeat before:bg-contain before:content-[''] w-full block mb-[10px]"
                                            >
                                                {planItem}
                                            </li>
                                        ))}
