        ...
        <div className="w-full">
          ...
          >
            {Disciplinary_list.map((item, index) => (
              <SwiperSlide key={item?.id} className={`w-full !h-auto pt-[15px] xl:pt-[25px] 2xl:pt-[30px] 3xl:pt-[35px]`}>
                <div
                ...
                >
                  ...
                  >
                    <div
                      className={`${index % 2 === 0 ? "text-[rgba(255,255,255,0.66)] " : "text-[rgba(103,20,72,0.36)]"}
                  ...
                  <div className="w-full text-start">
                    <div>
                      ...
                      <div
                        // key={liIndex}
                        className={`${
                          index % 2 === 0 ? "text-white before:bg-[#fff]" : "text-[#671448] before:bg-[#671448]"
