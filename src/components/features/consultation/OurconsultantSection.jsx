...
export default function OurconsultantSection() {
                    ...
                    {items.map((item) => (
                        <div key={item.id} className="w-full 2xs:w-1/2 p-[4px] md:p-[8px] 2xl:p-[20px] 3xl:p-[30px]">
                            <div className="w-full h-full p-[8px] xl:p-[15px] 3xl:p-[20px] rounded-[4px] border-[#D6E2ED] border overflow-hidden bg-white flex flex-wrap">
                                ...
                                {/* Right Section */}
                                <div className={`w-full lg:w-[calc(100%-165px)] xl:w-[calc(100%-210px)] 2xl:w-[calc(100%-250px)] 3xl:w-[calc(100%-315px)] lg:pl-[15px] xl:pl-[20px] 3xl:pl-[30px] transition-all duration-300`}>
