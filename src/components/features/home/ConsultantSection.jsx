              ...
              <SwiperSlide key={item.id}>
                ...
                >
                  ...
                  <div className="w-full cmnBx flex-grow  xl:w-[210px] 2xl:w-[250px] 3xl:w-[315px] lg:h-full">
                    <div className="w-full lg:h-full rounded-[6px] overflow-hidden aspect-[375/270] mb-[15px] bg-[#D6E2ED] relative imgBx">
                      ...
                      <Image
                        ...
                        alt="logo"
                      />
                      <Image src={item.image} className="w-full lg:h-full object-cover" width={375} height={270} alt={item.name} />
                    </div>
                    <div className="info">
                  ...
                  >
                    ...
                    <div className="text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[#3D3D3D] font-light uppercase">{item.qualification}</div>
                    ...
                    <div className="w-full mt-[15px]">
                      ...
                      <div className="text-[11px] 2xl:text-[13px] 3xl:text-[16px] text-[#671448] font-medium mb-[10px] 3xl:mb-[15px]">
                        Specialization
                      </div>
