        ...
        <section className="py-[50px_70px] overflow-hidden bg-[#FBFBFB]">
            <div className="container">
                ...
                <div className="flex items-end justify-between mb-[35px] 2xl:mb-[50px] 3xl:mb-[90px] flex-wrap gap-[20px]">
                    ...
                    <motion.p className="line-clamp-4 max-w-[326px] xl:max-w-[400px] 2xl:max-w-[468px] 3xl:max-w-[600px] mb-0"
                    ...
                    <Link href="/" className="btn-base1 hover" aria-label="know_more">View All Services</Link>
                        ...
                        {services.map((item, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div
                                        className={`relative w-full bg-[rgba(255,255,255,0.85)] rounded-[6px] p-[20px_15px] xl:p-[25px_20px] 2xl:p-[30px_25px] 3xl:p-[30px_40px_20px] transition-all z-20 duration-500 ${activeIndex === index
                                    ...
                                    >
                                        ...
                                        <Link href="/" className="text-[10px] 2xl:text-[12px] 3xl:text-[15px] text-[#671448] font-medium uppercase flex items-center transition-all mt-[20px]
