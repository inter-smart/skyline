...
const items = [
  { title: "Expert Consultants", description: "GMC-registered experts across 15+ medical specialties with NHS & private experience" },
  { title: "Advanced Technology", description: "GMC-registered experts across 15+ medical specialties with NHS & private experience" },
  { title: "Personalized Care", description: "Tailored treatment plans focused on your health journey" },
  { title: "Affordable Excellence", description: "High-quality private healthcare at transparent, competitive prices" },
];

const points = ["CQC Outstanding Rating", "NHS Partnership", "Joint Commission Accredited"];

export default function WhySection({ home_cms = {}, features = items }) {
  const {
    section2_description,
    section2_pre_title,
    section2_title,
    section2_card_icon_alt_text_value,
    section2_card_icon_value,
    section2_image_value,
    section2_image_alt_text_value,
            ...
            <div className="w-full h-full lg:pr-[20px] xl:pr-[25px] 2xl:pr-[30px] 3xl:pr-[40px] relative">
              ...
              >
                ...
                <div className="max-w-[45px] xl:max-w-[50px] 2xl:max-w-[75px] 3xl:max-w-[95px] mb-[10px]">
                  <Image
                    src={section2_card_icon_value || "/images/whyIcon.png"}
                    width="95"
                    height="95"
                    alt={section2_card_icon_alt_text_value || "health_icon"}
              ...
              <div className="w-full h-full lg:max-w-[350px] xl:max-w-[440px] 2xl:max-w-[525px] 3xl:max-w-[660px] ml-auto overflow-hidden rounded-[6px] aspect-[660/810]">
                <Image
                  src={section2_image_value || "/images/whySec.jpg"}
                  width="660"
                  height="810"
                  className="w-full h-full"
                  alt={section2_image_alt_text_value || "health_image"}
                />
              </div>
            </div>
          </motion.div>
