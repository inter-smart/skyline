      ...
      <div className="container h-full w-full flex items-center relative z-20">
        <div className="w-full relative z-20">
          ...
          >
            ...
            <motion.p
              className={`text-[12px] 2xl:text-[14px] 3xl:text-[18px]   ${showFormBox ? "text-white " : "text-[#212121]"
                } mb-[20px] max-w-[650px]`}
              variants={textAnimation}
          ...
          {showFormBox && (
           ...
           max-w-[550px] xl:max-w-[690px] 2xl:max-w-[820px] 3xl:max-w-[1040px] w-full mt-[20px] xs:mt-[30px] xl:mt-[40px]">
              <div className="flex flex-wrap w-full h-full">
                <div className="w-full h-full xs:w-[calc(100%-105px)] xl:w-[calc(100%-130px)] 2xl:w-[calc(100%-160px)] 3xl:w-[calc(100%-200px)] 
                      ...
                      <div className="w-[calc(100%-15px)] 2xl:w-[calc(100%-23px)] ">
                        <Select className="h-full">
                          ...
                          <SelectContent className="!text-[8px] xl:!text-[10px] 2xl:!text-[11px] 3xl:!text-[15px] placeholder:!text-[8px] xl:placeholder:!text-[10px] 2xl:placeholder:!text-[11px] 3xl:placeholder:!text-[15px]">
                            <SelectItem
                              value="search"
                              className="text-[10px] 2xl:text-[11px] 3xl:text-[15px]"
                            >
                              Search by name
                            </SelectItem>
                            <SelectItem
                ...
                <div className="w-full   xs:w-[105px] xl:w-[130px] 2xl:w-[160px] 3xl:w-[200px]  max-xs:p-[5px]">
                  <Button className="text-[8px] xl:text-[10px] 2xl:text-[11px] 3xl:text-[15px] btn-base1 hover bg-base2 rounded-[2px] 
                  w-full !min-h-full !h-full tracking-wider" aria-label="consultation_btn">SEARCH</Button>
                </div>
              </div>
            </div>
          )}
