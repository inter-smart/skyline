...
export default function InnerBanner({ img, subTitle, Title, description, alt, showFormBox = false }) {
  return (
    <section
      className={`w-full relative py-[30px] flex items-center ${showFormBox ? "h-auto min-h-[300px] xl:min-h-[375px] 2xl:min-h-[450px] 3xl:min-h-[565px]" : "h-[300px] xl:h-[375px] 2xl:h-[450px] 3xl:h-[565px]"
        }`}
    >
      <Image
        src={img}
      ...
      <div className="container h-full w-full flex items-center relative ">
        <div className="w-full relative">
          ...
          {showFormBox && (
            <div className="bg-[rgba(255,255,255,0.4)] p-[10px_4px] lg:p-[8px_10px] 2xl:p-[8px_12px] 3xl:p-[10px_15px]   
                    ...
                    <div className="w-full  bg-white flex items-center p-[0_10px] 2xl:p-[5px_10px] 3xl:p-[5px_15px]">
                      ...
                      <div className="w-[calc(100%-15px)] 2xl:w-[calc(100%-23px)] ">
                        <Select className="h-full">
                          <SelectTrigger
                            className="!text-[10px] 2xl:!text-[11px] 3xl:!text-[15px] w-full border-none outline-none shadow-none 
