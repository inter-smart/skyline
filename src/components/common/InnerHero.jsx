...
export default function InnerHero({ type, path_mob, path, alt, sub_title, title, title_highlight, description, children, className }) {
  return (
    <section className="w-full h-screen max-h-[280px] sm:max-h-[360px] lg:max-h-[390px] 2xl:max-h-[550px] 3xl:max-h-[565px] flex items-start sm:items-center py-[80px] sm:py-[60px] xl:py-[80px] 3xl:py-[100px] relative z-0">
      ...
      {type === "video" ? (
        ...
        <picture className="absolute -z-2 inset-0">
          ...
          <Image src={path} alt={alt || "image alt text"} fill sizes="1920px" className="-z-2 object-cover" />
        </picture>
      )}
