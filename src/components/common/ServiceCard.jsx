...
export default function ServiceCard({ service }) {
    return (
        ...
        >
            ...
            <div className={`relative bg-[rgba(255,255,255,0.85)] rounded-[6px] p-[20px_15px] xl:p-[25px_20px] 
            ...
            >
                ...
                <div className="text-[8px] xl:text-[10px] 3xl:text-[11px] text-[#671448] font-medium uppercase flex items-center transition-all group duration-200 hover:text-base2 
